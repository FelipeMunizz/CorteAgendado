        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HorarioAbertura = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HorarioFechamento = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TempoServiço = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Barbearias_Configuracao_ConfiguracaoId",
                        column: x => x.ConfiguracaoId,
                        principalTable: "Configuracao",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Barbearias_Contato_ContatoId",
                        column: x => x.ContatoId,
                        principalTable: "Contato",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Barbearias_Endereco_EnderecoId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Clientes_Contato_ContatoId",
                        column: x => x.ContatoId,
                        principalTable: "Contato",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Funcionarios_Barbearias_BarbeariaId",
                        column: x => x.BarbeariaId,
                        principalTable: "Barbearias",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Barbearias_ConfiguracaoId",
                table: "Barbearias",
                column: "ConfiguracaoId");

            migrationBuilder.CreateIndex(
                name: "IX_Barbearias_ContatoId",
                table: "Barbearias",
                column: "ContatoId");

            migrationBuilder.CreateIndex(
                name: "IX_Barbearias_EnderecoId",
                table: "Barbearias",
                column: "EnderecoId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Funcionarios_BarbeariaId",
                table: "Funcionarios",
                column: "BarbeariaId");
